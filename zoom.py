...
def zoom_all(parsed_data, selected_ids, selected_labels, nearest_to_ball = 0, x_padding = 10, y_padding = 10, x_interp = 0.5, y_interp = 0.5, zoom_interp = 0.5, H_out = 0, W_out = 0):
...
def zoom_save_gif(out_file, fps, selected_ids, selected_labels, nearest_to_ball, x_padding, y_padding, x_interp, y_interp, zoom_interp):
    # base_path = 'C:\Users\chris\OneDrive\Documents\Penn\CIS 5810\Final Project git test\CIS581-Final-Project-main'
    ...
    results = zoom_all(corrected_data,  selected_ids, selected_labels, nearest_to_ball, x_padding, y_padding, x_interp, y_interp, zoom_interp)
